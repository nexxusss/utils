...
add_similar = input("Do you want to add similar files in the search results?\n(Y/N): ")
...
def search(file_name):
    ...
    for root,_, files in os.walk(r"C:\\"):
        for file in files:
            ...
            elif add_similar == 'Y' and res_perc(list(file_name), list(file))>=50.0 and (list(file)[0] == list(file)[0]):
